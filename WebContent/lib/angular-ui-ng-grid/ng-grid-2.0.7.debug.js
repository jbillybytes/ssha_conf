...
window.ngGrid.i18n['en'] = {
    ...
    ngGroupPanelDescription: 'Use filter on right to narrow your search:',
...
angular.module("ngGrid").run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("menuTemplate.html",
    ...
    "               <input ng-disabled=\"col.pinned\" type=\"checkbox\" class=\"ngColListCheckbox\" ng-model=\"col.visible\"/><span class=\"ngColListLabel\">{{col.displayName}}</span>" +
